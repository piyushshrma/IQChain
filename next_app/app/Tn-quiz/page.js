...
export default function QuizSection() {
  return (
    <div className="container mx-auto p-6 min-h-screen">
      ...
      <Link href="/QuizPage">
        <div className="max-w-md mx-auto bg-white rounded-3xl overflow-hidden shadow-md mb-12 cursor-pointer">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <Link href="/">
          <div className="max-w-xs bg-white rounded-3xl overflow-hidden shadow-md cursor-pointer">
            <div className="relative">
              <Image
                src={Quiz1}
                alt="Upcoming Quiz 1"
